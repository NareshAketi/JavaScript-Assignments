function Sum1() {
    var num = document.getElementById("inputnum1").value;
    console.log("Value submmited is:" + num);

    var sum = 0;
    for (i = 0; i <= num; i++) {
        sum = sum + i;
    }
    console.log("Sum of numbers till " + num + " is: " + sum);
    alert("Sum of numbers till " + num + " is: " + sum);
}
...
function Sum2() {
    ...
    console.log("Sum of multiples of 3, 5 till " + num + " is: " + sum);
    alert("Sum of numbers till " + num + " is: " + sum);
